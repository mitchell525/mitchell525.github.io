...
Everything in one place:
 ...
 - Build packing lists you can reuse for your next trip
 - Track spending with a simple budget and expense list
 - Set reminders for passports, check-in times, and other important dates
...
**Does it work on Mac?** Yes. Pocket Trip Planner is a real Mac app, with a menu bar, keyboard shortcuts, and right-click menus—not just an iPhone app stretched onto a bigger screen.

**Is Pro a subscription?** No. Pro is a one-time purchase that unlocks its features for good.

**Does the AI in Pro send my trip data anywhere?** No. Those features work entirely on your device, so your itinerary and photos are never sent to a server to make suggestions or import your plans.
